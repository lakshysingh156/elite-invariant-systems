    ...
    <section className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <div className="absolute -inset-x-20 -top-32 h-64 bg-[radial-gradient(ellipse_at_center,var(--signal),transparent_60%)] opacity-[0.08]" />
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link
                to="/signup"
                className="group inline-flex items-center gap-2 rounded-full bg-signal px-5 py-2.5 text-sm font-medium text-signal-foreground transition-transform hover:scale-[1.03] active:scale-95"
              >
                Get started free
